...
@php
$base = 'inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors';
...
$badgeClasses = 'inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-medium ' . ($badgeColors[$badgeColor] ?? $badgeColors['zinc']);
@endphp
